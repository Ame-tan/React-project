...
function Ring() {
  ...
  const closeAlert = () => {
    ...
    const { data, error } = useSWR("http://localhost:4000/products?_embed=images&category=飾品&type=ring", fetcher);
    ...
    const ringProducts = (data||[]).filter((product) => product.category === "飾品" && product.type === "ring" );
