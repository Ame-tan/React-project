...
function Necklace() {
  ...
  const closeAlert = () => {
    ...
    const { data, error } = useSWR("http://localhost:4000/products?_embed=images&category=飾品&type=necklace", fetcher);
    ...
    const necklaceProducts =(data||[]).filter((product) => product.category === "飾品" && product.type === "necklace" );
