...
function Necklace() {
    ...
    const necklaceImages = images.filter((n) => n.category === "飾品" && n.type === "necklace" );
            ...
            {necklaceImages.map((n) => (
              ...
              >
                <div className="relative group  ">
                  <button>
                    <img src={n.image} alt={n.description} />
                  </button>
